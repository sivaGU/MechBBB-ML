"""
CalcBB CLI. Predict from command line.
Usage:
  python -m src.calcbb.cli --smiles "CCO" "c1ccccc1" --output out.csv --artifact-dir .
  python -m src.calcbb.cli --input example_inputs.csv --output out.csv --artifact-dir .
"""
import argparse
import csv
import sys
...
def main():
    parser = argparse.ArgumentParser(description="CalcBB BBB permeability predictor")
